  ...
  return (
    <section className="bg-white py-16 sm:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center mb-3">Como funciona</h2>
        <p className="text-gray-500 text-base mb-12 max-w-2xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {[
            ...
            <div key={step.title} className="step-line relative flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-red-600 text-white flex items-center justify-center mb-4 shadow-md relative z-10">
