        ...
        <div className="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-stack-large md:py-[80px]">
          <div className="max-w-3xl">
            ...
            <p className="text-body-large font-body-large text-tertiary-fixed-dim mb-stack-large">
              Mais de <strong className="text-white">{carCount.toLocaleString("pt-BR")}</strong> veículos verificados e prontos para você.
            </p>
              ...
              <form onSubmit={handleSearch}>
                ...
                <div className={`grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 ${showAdvanced ? "" : "hidden"}`}>
                  ...
                  <div className="relative">
                    ...
                    <select className="w-full border border-border-subtle rounded px-3 py-3 focus:border-primary focus:ring-1 focus:ring-primary text-body-medium text-on-surface bg-transparent appearance-none" value={selectedTransmission} onChange={e => setSelectedTransmission(e.target.value)}>
                      <option value="">Todos</option>
                  ...
                  <div className="relative">
                    ...
                    <select className="w-full border border-border-subtle rounded px-3 py-3 focus:border-primary focus:ring-1 focus:ring-primary text-body-medium text-on-surface bg-transparent appearance-none" value={selectedKmRange} onChange={e => setSelectedKmRange(e.target.value)}>
                      <option value="">Todos</option>
